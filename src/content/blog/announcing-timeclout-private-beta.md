---
title: "Introducing TimeClout: A New, Open-Source Tool to End Shift Scheduling Headaches"
description: ""
...
Pedro here. As most of you know, I spend my days as a software engineer, building tools and solving problems. Usually, I'm working on code for other people, but today, I’m incredibly excited to announce a personal project that I’m finally ready to share with the world: **[TimeClout.com](https://timeclout.com)**.

And yes, we're officially opening up the private beta today\!

![Astronauts at work](/images/blog/astronauts_at_work.jpg)

### The Accidental Origin Story

[TimeClout](https://timeclout.com) didn't start as a business idea. It didn't start with market research or a pitch deck.
...
**I've decided to make the entire [TimeClout](https://timeclout.com) project open-source.**

You can see every line of code, fork it, and poke around in the repository right here:
**[https://github.com/djinilabs/timeclout](https://github.com/djinilabs/timeclout)**

This wasn't a casual decision. I did it for two very specific reasons:

1.  **For Peace of Mind:** We've all seen it. You find a cool, new SaaS tool, build your entire workflow around it, and then... it disappears. The company gets acquired, pivots, or just shuts down, leaving you high and dry. I don't want that for [TimeClout](https://timeclout.com) users. If, for whatever reason, the [TimeClout.com](https://timeclout.com) service disappears, the tool itself won't. You can always grab the code and the community can keep it alive.
2.  **For Flexibility (and Control):** Maybe you don't want _another_ cloud subscription. Maybe you have strict data privacy requirements and need to keep everything on your own servers. Go for it. You can host [TimeClout](https://timeclout.com) yourself, lock it down, and modify it however you see fit.
...
But it's also for any business owner, team lead, or manager who is tired of fighting with spreadsheets. If you run a retail shop, a restaurant, a call center, a dev-ops team with on-call rotations, or _any_ kind of team that works in shifts... I built this for you.
...
**[Sign up for the TimeClout private beta here\!](https://timeclout.com)**
